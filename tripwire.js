function tripwire() {   
    if (level == 0){
        ...
        }   else if (wire == 3){ //if two pressure plates are pressed, deactivates all tripwires
            graphicMap[12][6] = 6;
            graphicMap[12][7] = 6;
            graphicMap[12][2] = 6;
            graphicMap[12][3] = 6;
        ...
        } else if (wire == 4){ //if two pressure plates are pressed, deactivates all tripwires
            graphicMap[12][6] = 6;
            graphicMap[12][7] = 6;
            graphicMap[12][2] = 6;
            graphicMap[12][3] = 6;
        ...
        } else if (wire >= 5){ //if two pressure plates are pressed, deactivates all tripwires
            graphicMap[12][6] = 6;
            graphicMap[12][7] = 6;
            graphicMap[12][2] = 6;
            graphicMap[12][3] = 6;
